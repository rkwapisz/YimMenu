...
namespace big
{
	...
	public:
		...
		NLOHMANN_DEFINE_TYPE_INTRUSIVE(reaction, announce_in_chat, is_team_only, notify, log, add_to_player_db, block_joins, block_join_reason, kick, kick_only_if_host, timeout)
